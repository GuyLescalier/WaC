...
if ($Mode -eq 'Expand') {
    ...
    foreach ($g in $groups) {
        ...
        foreach ($item in $items) {
            ...
            # CORRIGÉ : Génération systématique du nom. _originalName est abandonné pour un format plus lisible.
...
foreach ($res in $dsc.resources) {
    ...
    # CORRIGÉ : La sauvegarde du nom original est abandonnée pour un format plus compact.
